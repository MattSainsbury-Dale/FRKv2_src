...
source("./src/Plotting_helpers/MODIS_plotting_fns.R")
...
## Run the study with multiple training data sets. We source MODIS.R in a loop, 
...
## iii) the exposition and showing the results is complicated if we have multiple runs.
...
ggsave(figure,
       path = "./img/", filename = "MODIS_data.png", device = "png", 
       width = 10, height = 2.2)
...
ggsave(plot_predictions(all_df_test, "MAR"),
       path = "./img/", filename = "MODIS_MAR_predictions.png", device = "png", 
       width = 10, height = 5.1)

ggsave(plot_predictions(all_df_test, "block"),
       path = "./img/", filename = "MODIS_block_predictions.png", device = "png",
       width = 12, height = 2.5)   
...
ggsave(figure, path = "./img/", filename = "MODIS_ROC.png", device = "png", 
       width = 6, height = 2.6)
