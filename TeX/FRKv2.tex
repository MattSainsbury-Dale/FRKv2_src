...
\Abstract{
 ...
 This new version of \pkg{FRK} also allows for the use of a large number of basis functions when modelling the spatial process, and is thus often able to achieve more accurate predictions then previous versions of the package in a Gaussian setting.   
...
For \pkg{spBayes}, we used 289 knots; increasing the number of knots further was computationally prohibitive. 
